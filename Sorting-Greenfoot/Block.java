...
public class Block extends Actor
{
    ...
    public Block(int heightIn, int widthOfInterface, int valueIn, int maxValue, boolean... debugFlag) {
        ...
        createDisplayImage(Color.BLACK);
     ...
     */
    protected void createDisplayImage(Color colour) {
        ...
        GreenfootImage box = new GreenfootImage( Integer.toString(value)+spacer,height,Color.RED,colour);
        setImage(box);
    }
